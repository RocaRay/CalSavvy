// use in case of emergency of breaking everything during refactor
    ...
    return (
      <div>
        ...
        <div id="ButtonsContainer">
          <HookedButtonsContainer addItemAndCalories={this.addItemAndCalories} logDay={this.logDay} toggleDisplay={this.toggleDisplay}/>
        </div>
      </div>
    )
  }
